...
def generateCircuits(distances, numCoordinates):
    circuits = []
    while True:
        ...
        if len(circuits) == 1 and len(circuits[0]) == numCoordinates:
            return distance
...
lastCoordinates = generateCircuits(distances, len(coordinates))
print(lastCoordinates[0][0] * lastCoordinates[1][0])