...
def astar(maze, start, facing, end):
    ...
    while len(openList) > 0:
        ...
        if currentNode.facing == 'N' or currentNode.facing == 'S':
            if currentNode.numberMovesForwards < 3:
                newPositions = [(-1 if currentNode.facing == 'N' else 1, 0, currentNode.facing, currentNode.numberMovesForwards + 1)]
            else:
                newPositions = [(0, 1, 'E', 0), (-1 if currentNode.facing == 'N' else 1, 0, currentNode.facing, currentNode.numberMovesForwards + 1), (0, -1, 'W', 0)]
        else:
            if currentNode.numberMovesForwards < 3:
                newPositions = [(0, -1 if currentNode.facing == 'W' else 1, currentNode.facing, currentNode.numberMovesForwards + 1)]
            else:
