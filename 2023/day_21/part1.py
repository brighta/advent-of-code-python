    ...
    while stepsTaken < numSteps:
        ...
        for point in currentPoints:
            ...
            for pointOption in pointOptions:
                ...
                if newPoint[0] >= 0 and newPoint[0] < len(grid[0]) and newPoint[1] >= 0 and newPoint[1] < len(grid[1]) and grid[newPoint[1]][newPoint[0]] != '#':
...
answer = findPointsReached(grid, start, 64)
print(answer)
