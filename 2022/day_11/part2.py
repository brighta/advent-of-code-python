...
for monkey in monkeys:
    print(monkey)
lowestCommonMultiplier = prod([monkey.get_test_value() for monkey in monkeys])
for monkey in monkeys:
    monkey.set_lowest_common_multiplier(lowestCommonMultiplier)
for i in range(10000):
    for monkey in monkeys:
        monkeys = monkey.perform_operations(monkeys, False)
